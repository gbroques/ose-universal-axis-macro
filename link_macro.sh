#!/bin/sh
# --------------------------------------------------------------------------- #
# Create a symbolic link of UniversalAxis.FCMacro to FreeCAD macro directory. #
# --------------------------------------------------------------------------- #
...
# Soft link macro and package from repositiory to user's FreeCAD macro directory
ln -s $(pwd)/UniversalAxis.FCMacro $macro_dir/UniversalAxis.FCMacro
ln -s $(pwd)/universal_axis $macro_dir/universal_axis
